...
const ProofOfExistenceModal = ({toggle, handleImage, send, sending, change}) => {
  ...
  return (
    <div className='w-full text-sm h-screen flex items-center justify-center bg-black bg-opacity-50 fixed top-0 left-0 z-50'>
        ...
        <h2 className='text-gray-600 text-lg font-semibold capitalize'>Add Proof</h2>
...
export default ProofOfExistenceModal